...
[tmuxr](https://jeronejanssens.github.io/tmuxr) and
[rexpect](https://jeroenjanssens.github.io/rexpect) in order to make my book _Data Science at the Command Line_ available online, in the same way as Hadley Wickham and Garrett Grolemund's _R for Data Science_. Now that these packages are open source, I hope that they'll enable others to create beautiful R Markdown documents with their favorite programming language or REPL.
